...
{
    if (nmImage) [self setImage:nmImage forState:UIControlStateNormal];
    if (hlImage) [self setImage:hlImage forState:UIControlStateHighlighted];
    if (selImage) [self setImage:selImage forState:UIControlStateSelected];
}
...
{
    if (nmColor) [self setTitleColor:nmColor forState:UIControlStateNormal];
    if (hlColor) [self setTitleColor:hlColor forState:UIControlStateHighlighted];
    if (selColor) [self setTitleColor:selColor forState:UIControlStateSelected];
}
