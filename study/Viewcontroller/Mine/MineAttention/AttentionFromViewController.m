...
@interface AttentionFromViewController ()<UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, MinePartnerCoreDelegate>

@end

static NSString *_sectionIdentifier = @"_sectionIdentifier";

@implementation AttentionFromViewController
{
